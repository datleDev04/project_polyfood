<main class="w-full mt-14">
        ...
        <div class="form__login my-10 w-full flex justify-center mb-20">
          <form action="update-account.php" method="post" enctype="multipart/form-data" class="form__login--content w-[900px] sm:w-[900px]  flex flex-col  gap-7">
            <?php
            if (strlen($MESSAGE)) {
            ...
            <div class="flex justify-around col-span-2">
                ...
                <div class="form__group flex flex-col gap-2 mb-6">
                    ...
                    <img class="" style="width:150px;height:150px;display:block;margin:0 auto;" src="<?= $CONTENT_URL ?>/images/users/<?= $image ?>">
                    </div>
                </div>
            ...
            <div class="form__group flex  justify-center items-center gap-3">
                    ...
                    <button type="reset" name="btn_reset" class="text-white bg-orange-600 p-2 mb-6 rounded-lg w-full sm:w-[100px] text-center">
                        RESET
                    </button>
                    </div>
            <div>
