<main class="w-full mt-14">
        ...
        <div class="form__login my-10 w-full flex justify-center mb-20">
            <form action="?url=quenmk" method="post" enctype="multipart/form-data" class="form__login--content w-[300px] sm:w-[500px]  flex flex-col  gap-4">
                <?php
                if (strlen($MESSAGE)) {
                ...
                <div class="form__group flex flex-col gap-2">
                  ...
                  focus:border-orange-500 focus:outline-none" placeholder="Tên đăng nhập" <?=$user_name?> />
                ...
                <div class="form__group flex flex-col gap-2">
                  ...
                  focus:border-orange-500 focus:outline-none" placeholder="example@gmail.com" <?=$password?>/>
                    <span class="text-red-500 text-xs">
