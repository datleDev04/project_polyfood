        ...
        <div class="">
            <form action="#" method="POST">
                ...
                <div class="flex items-center py-4 space-x-2 ">
                    ...
                    <p class="text-sm text-gray-500"><?= $view ?>
                        Phản hồi
                    </p>
                </div>
...
<section class="max-w-6xl mx-auto mt-20">
    <div class="flex items-center justify-center space-x-4 button-box">
        ...
        <button type="button" class="toggle-btn" onclick="rightClick()"><span id="phai" class="inline-block px-8 py-2 text-xl text-red-500 rounded-xl ">Nhận xét ( <?= $view ?>
                )</span></button>
    </div>
