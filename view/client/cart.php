...
<div class="flex flex-col gap-1 my__cart-title sm:flex-row sm:justify-between">
    ...
    <div class="flex flex-col gap-5 my-6 cart__info md:flex-row lg:gap-6">
        ...
        <div style="
            ...
            <?php foreach($_SESSION['my_cart'] as $item) {?>    
            <div class="product__item  flex justify-between items-center rounded-lg border-[3px] border-dashed p-3 relative">
                <div class="flex gap-2 sm:gap-5">
                    <div class="flex product__img ">
                        <img style="width:100px; height:100px;" class="rounded-lg  object-cover object-center"
                            src="src/assets/images/products/<?=$item['image']?>" alt="" />
                    </div>
            ...
            <?php } } else{?>
                ...
                <div class="flex flex-col items-center justify-center">
                    <img style="width:1000; height:200;" src="src/assets/images/layout/empty-cart.png" alt="">
    ...
    <a href="?url=allproduct" class="flex mt-10 text-sm font-semibold text-indigo-600">
