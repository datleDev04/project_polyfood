...
1.5px 1.5px 2.5px #babecc, -2px -2px 5px #fff;"
                                    class=" ml-[500px] p-2  border rounded-md w-[120px] text-center   text-xs hover:bg-gray-200 leading-4 ">
                                    <a  href="?url=adddm">
                                        Thêm mới
                                    </a>
                                </button>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="border-t-2 border-dashed">
                                            ...
                                            <td class="px-5  whitespace-nowrap">
                                                <div class="box__action flex gap-2 justify-center">
                                                    ...
                                                    <a href="?url=recover_category&category_id=<?= $category_id ?>" name="btn_delete"
                                                        class="text-indigo-600 hover:text-indigo-900"> <i class="fa-solid fa-unlock"></i>
                                                    </a>
                                                </div>
                                            </td>
                                        </tr>
