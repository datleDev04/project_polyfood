...
1.5px 1.5px 2.5px #babecc, -2px -2px 5px #fff;" class="ml-[600px] p-2  border rounded-md w-[120px] text-center   text-xs hover:bg-gray-200 leading-4 ">
            ...
            <a href="index.php?url=product"style="text-shadow: 0.6px 0.6px 0 #fff; color: #61677c; box-shadow:
                            ...
                            <tr class="border-t-2 border-dashed">
                                ...
                                <td class="px-2 whitespace-nowrap">
                                    <div class="flex gap-3 box__action justify-center">
                                        ...
                                        <a href="index.php?url=recover_product&product_id=<?= $product_id ?>" class="text-indigo-600 hover:text-indigo-900"><i class="fa-solid fa-unlock"></i>
                                        </a>
                                    </div>
                                </td>
                            </tr>
