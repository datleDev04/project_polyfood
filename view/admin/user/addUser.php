...
" class="w-full h-[60px] flex items-center justify-between px-5 py-2">
                    ...
                    <div class="account__admin flex items-center gap-2">
                        ...
                        <div class="account__admin--name flex flex-col gap-1">
                            ...
                            <a href="index.php?url=logout" class="logout text-xs text-gray-500 flex items-center gap-1">
...
#bebebe, -35px -35px 70px #ffffff; " class="w-full  p-5 mt-5 bg-gray-100">
                    ...
                    <section class="add__user w-full mt-5">
                        ...
                        <section class="mt-5  w-full">
                            <form action="?url=addUser" class="form__add-user w-full" method="post" enctype="multipart/form-data">
...
" />
                                    ...
                                    <div class="form__group flex flex-col ">
                                        <label class="text-xs sm:text-sm md:text-base lg:text-base text-gray-500" for="name">Họ và
                                            tên</label>
                                        <input type="text" class="form__input-add__prodcut shadow-2xl border border-gray-200 focus:outline-none text-xs sm:text-sm md:text-base lg:text-base bg-gray-100 mt-2 p-2 px-3  rounded-md text-gray-500 " name="name" id="name" placeholder="Nhập họ và tên..." value="<?= $name ?>" />
                                        <span class="text-red-500 text-xs">
                                ...
                                <div class="form__add-user--list-button w-full mt-7 flex gap-3 justify-center items-center">
                                    <button type="submit" name="insert" style="text-shadow: 0.6px 0.6px 0 #fff; color: #61677c; box-shadow: 1.5px 1.5px
